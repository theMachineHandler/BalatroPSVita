...
-- Creates log.txt
-- inside ux0:/data for logging data :v
local function initializeLogger()
  if not _IS_LOGGING then
    ...
    function Logger.print_all(...)
      for i, v in ipairs{...} do
        if type(v) == "table" then
          Logger.logfile("arg " .. tostring(i+2) .. ": " .. Logger.tprint(v) .. "; ")
        else
          Logger.logfile("arg " .. tostring(i+2) .. ": " .. tostring(v) .. "; ")
        end
      end
    end
